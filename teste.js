...
function AlteraRele2(){
    ...
    if(estado_2 === "0"){
		...
		document.getElementById("botao_2").innerHTML="<a href='' class='botao_4'>Ligado</a>";
        ...
        document.getElementById("botao_2").innerHTML="<a href='/?2_ligar' class='botao_2'>Exaustor</a>";
    }
}
